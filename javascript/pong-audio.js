...
export var paddleSound = new soundFile("ball.mp3");
...
export var adventureMusic = new soundFile("KeyChimes.mp3");
soundArray.push(adventureMusic);
adventureMusic.player.loop = true;
adventureMusic.player.volume.value = -16;

export var villageMusic = new soundFile("village music.mp3");
